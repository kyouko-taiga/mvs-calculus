...
extension Diagnostic {
  ...
  static func missingAnnotation(decl: BindingDecl) -> Diagnostic {
    return Diagnostic(
      range: decl.range,
      message: "type annotation missing in binding declaration")
  }

  static func missingExprInNonVoidFunc(literal: FuncExpr) -> Diagnostic {
    return Diagnostic(
      range: literal.range,
      message: "missing expression in non-void function")
  }
